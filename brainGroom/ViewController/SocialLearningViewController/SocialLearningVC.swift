...
class knowledgeMenuTVC: UITableViewCell
{
...
class SocialLearningVC: UIViewController, UITableViewDelegate, UITableViewDataSource, FCAlertViewDelegate
{
...
//MARK: ------------------------ TV Delegates & DataSource ---------------------------
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        if tableView == TV
        {
        let cell = tableView.dequeueReusableCell(withIdentifier: "PostTVCell") as! PostTVCell
...
//        cell.commentBtn.addTarget(self, action: #selector(self.commentBtnAction(_:)), for: .touchUpInside)
        ...
        {
            let cell = tableView.dequeueReusableCell(withIdentifier: "knowledgeMenuTVC", for: indexPath as IndexPath) as! knowledgeMenuTVC
    ...
    func likeUnlikeBtnAction(_ sender: UIButton)
    {
        ...
        let cell = self.TV.dequeueReusableCell(withIdentifier: "PostTVCell", for: selectedIndex) as! PostTVCell
    ...
    @IBAction func closeMenuBackBtnAction(_ sender: Any)
    {
        AFWrapperClass.viewSlideInFromLeftToRight(view: sideMenuView)
        sideMenuView.isHidden = true
    }
    ...
    func alert(text: String)
    {
        ...
        alert.showAlert(in: self.appDelegate.window, withTitle: "Braingroom", withSubtitle: text , withCustomImage: nil, withDoneButtonTitle: nil, andButtons: nil)
        alert.hideDoneButton = true;
...
extension SocialLearningVC : UISearchBarDelegate {
