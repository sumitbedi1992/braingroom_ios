...
class DiscussionMenuTVC: UITableViewCell
{
...
class DiscussionPostTVCell: UITableViewCell
{
...
class DiscussionVC: UIViewController,UITableViewDelegate,UITableViewDataSource,FCAlertViewDelegate
{
...
//        self.postsApiHitting()
    ...
    func postsApiHitting()
    {
        ...
        let innerParams : [String: Any] = [
            ...
            "is_my_group":0,
            "locality_id":"",
            "major_categ":"tutors_talk",
            "minor_categ":"user_post",
            "search_query":"",
            "seg_id":"",
            "state_id":"",
            "user_id":userId()
...
//        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        if tableView == TV
        {
            let cell = tableView.dequeueReusableCell(withIdentifier: "DiscussionPostTVCell") as! DiscussionPostTVCell
...
//            cell.dateLbl.text = (self.dataArray.object(at: indexPath.row) as! NSDictionary).object(forKey: "date") as? String
            ...
            let str = (self.dataArray.object(at: indexPath.row) as! NSDictionary).object(forKey: "date") as? String
...
//            cell.shareBtn.addTarget(self, action: #selector(self.shareBtnAction(_:)), for: .touchUpInside)
        ...
        {
            let cell = tableView.dequeueReusableCell(withIdentifier: "DiscussionMenuTVC", for: indexPath as IndexPath) as! DiscussionMenuTVC
...
//                    self.navigationController?.pushViewController(vc, animated: true)
    ...
    func likeUnlikeBtnAction(_ sender: UIButton)
    {
        if userId() != ""
        {
            ...
            let cell = self.TV.dequeueReusableCell(withIdentifier: "DiscussionPostTVCell", for: selectedIndex) as! DiscussionPostTVCell
            ...
            AFWrapperClass.requestPOSTURL(baseURL, params: params, success: { (responseDict) in
                ...
                if (dic.object(forKey: "res_code")) as! String == "1"
                {
                    ...
                    if (self.dataArray.object(at:0) as! NSDictionary).object(forKey: "liked") as? String == "1"
                    {
                        cell.likeLbl.text = "liked"
...
extension DiscussionVC : UISearchBarDelegate {
