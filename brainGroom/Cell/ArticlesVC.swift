...
class ArticleMenuTVC: UITableViewCell
{
...
class ArticlePostTVCell: UITableViewCell
{
...
class ArticlesVC: UIViewController,UITableViewDelegate,UITableViewDataSource,FCAlertViewDelegate
{
...
//        self.postsApiHitting()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        if tableView == TV
        {
            let cell = tableView.dequeueReusableCell(withIdentifier: "ArticlePostTVCell") as! ArticlePostTVCell
...
//            cell.shareBtn.addTarget(self, action: #selector(self.shareBtnAction(_:)), for: .touchUpInside)
        ...
        {
            let cell = tableView.dequeueReusableCell(withIdentifier: "ArticleMenuTVC", for: indexPath as IndexPath) as! ArticleMenuTVC
    ...
    func likeUnlikeBtnAction(_ sender: UIButton)
    {
        if userId() != ""
        {
            ...
            let cell = self.TV.dequeueReusableCell(withIdentifier: "ArticlePostTVCell", for: selectedIndex) as! ArticlePostTVCell
