...
class ActivityMenuTVC: UITableViewCell
{
...
class ActivityPostTVCell: UITableViewCell
{
...
class ActivityVC: UIViewController,UITableViewDelegate,UITableViewDataSource,FCAlertViewDelegate
{
...
//        self.postsApiHitting()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        if tableView == TV
        {
            let cell = tableView.dequeueReusableCell(withIdentifier: "ActivityPostTVCell") as! ActivityPostTVCell
...
//            cell.shareBtn.addTarget(self, action: #selector(self.shareBtnAction(_:)), for: .touchUpInside)
        ...
        {
            let cell = tableView.dequeueReusableCell(withIdentifier: "ActivityMenuTVC", for: indexPath as IndexPath) as! ActivityMenuTVC
...
//                    self.navigationController?.pushViewController(vc, animated: true)
    ...
    func likeUnlikeBtnAction(_ sender: UIButton)
    {
        if userId() != ""
        {
            ...
            let cell = self.TV.dequeueReusableCell(withIdentifier: "ActivityPostTVCell", for: selectedIndex) as! ActivityPostTVCell
    ...
    @IBAction func postBtnAction(_ sender: Any)
    {
        ...
        vc.isFromActivityAndPartner = true
        self.navigationController?.pushViewController(vc, animated: true)
    }
